    ...
    if (cell == nil) {
        ...
        switch (indexPath.row) {
            case 0:
                ...
                [cell showCoin:@"199"];
                if (![[hintString substringWithRange:NSMakeRange(0, 1)] isEqualToString:@"@"])
                {
...
//                cell.backgroundView = test;
                cell.textLabel.text = @"Reveal a word";
                [cell.textLabel setFont:[UIFont fontWithName:@"Arial-BoldMT" size:15]];
                [cell showCoin:@"499"];
...
//                cell.backgroundView = test;
                [cell.textLabel setFont:[UIFont fontWithName:@"Arial-BoldMT" size:15]];
                cell.textLabel.text = @"Share and get 150 coins";
